...
describe('CategoryController (e2e)', () => {
  ...
  beforeAll(async () => {
    ...
    if (!existing) {
      ...
      await prisma.user.create({
        data: {
          ...
          password: hashedPassword, // ⚠️ doit être déjà hashé si auth le vérifie ainsi
      ...
      const payload = { userId: testUserId, email: testUser.email, userName: testUser.userName };
    ...
    // ✅ On s'assure que login a fonctionné
